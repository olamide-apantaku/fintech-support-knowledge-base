# Case Study: Improving Customer Support Performance at Finosell
...
across multiple digital channels including Email, 
WhatsApp, TikTok and Instagram. As the Customer 
Support Specialist, I was responsible for managing 
all customer interactions, resolving issues and 
...
- Identified repetitive inquiry patterns 
  across all channels
- Created response templates for common issues
- Streamlined ticket categorisation process
...
- Introduced follow up process to confirm 
  customer satisfaction after resolution

**3. Improving CSAT and NPS**
...
- Personalised communication directly impacts 
  CSAT and NPS scores
- Proactive follow ups prevent repeat contacts 
  and improve customer loyalty
- Documenting escalations creates a knowledge 
  base that improves team performance over time
